...
console.log(player.positionX);
       ...
       var x =width / 2 +100  
        var y = height - player.positionY;

       // var currentlife = allPlayers[plr].life;
       var currentlife = player.life;
...
//console.log("camera postion index" + index)
          // Changing camera position in y direction
          camera.position.y = cars[index - 1].position.y;
         // camera.position.y = cars[0].position.y;
        }
      }
  ...
  handlePlayerControls() {
    if (!this.blast) {
      if (keyIsDown(UP_ARROW)) {
        ...
        player.positionY += 10;
        console.log("player position " + player.positionY);
        //player.update();
      }
